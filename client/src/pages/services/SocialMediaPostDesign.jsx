...
const SocialMediaPostDesign = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Social Media Post Design Agency in Delhi</title>
                <meta name="description" content="Digital Marketing King is eminent and best Social Media Post Design Agency in Delhi, India. Get a Best Social Media Post Design Service in Delhi. let's Discuss Your Project Now." />
                <link rel="canonical" href="https://www.digitalmarketingking.in/social-media-post-design.php" />
            </Helmet>
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="banner-heading">
                                <h1 className="banner-title">Social Media Post Design</h1>
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="cta-heading-2 bx11">
                                    <img src="https://www.digitalmarketingking.in/img/dm/social-media-post-design-company-in-delhi.webp" className="img-fluid" alt="Social Media Post Design" />
                                    ...
                                    <p>Today, more than ever, social media has become a conduit between your customer and your business. The more you engage with the customer, the better the relationship becomes. Digital Marketing King provides social media graphic design services that are aimed at enhancing your business presence on social media.</p>

                                    <p>We deliver customized designs to fit your business so that your company pages can really evoke a feeling of quality and stand out against the competition.</p>

                                    <p>How you present yourself to the users of social media holds a lot of weight. For a social media marketing plan to work, consistent branding is required. No matter how good your social media marketing strategy is, without proper design nothing will work out because social media is a visual platform.</p>

                                    <p>Our professional designers understand that everything you do online will affect your ROI and company growth. That is why, at Digital Marketing King, our designers create marketing materials that will work for you. From full corporate identity, business cards to just a simple icon, our talented social media designers can create something professional and eye-catchy, while ensuring your brand standards are met.</p>
...
export default SocialMediaPostDesign;
