...
const InstagramMarketing = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Instagram Marketing Agency in Delhi</title>
                <meta
                    name="description"
                    content="Digital Marketing King is eminent and best Instagram Marketing Agency in Delhi, India. Get a Best Instagram Marketing Service in Delhi. let's Discuss Your Project Now."
                />
                <link rel="canonical" href="https://www.digitalmarketingking.in/instagram-marketing.php" />
            </Helmet>
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="banner-heading">
                                <h1 className="banner-title">Instagram Marketing</h1>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8">
                                <div className="cta-heading-2 bx11">
                                    <img src="https://www.digitalmarketingking.in/img/dm/instagram-marketing-agency-in-delhi.webp" className="img-fluid" alt="Instagram Marketing" />
